...
SELECT supplier_name FROM branch_supplier WHERE supplier_name LIKE "%Label%";
...
CREATE 
	...
	END $$
DELIMITER ;
INSERT INTO employee VALUES(111, "Pam", "Beeslytrigger_test", "1988-02-19", 'F', 69000, 106, 3);
